  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <p className="text-gray-600 mb-6">File yang disimpan akan berisi semua data proyek. Tanda tangani status penyimpanan sebagai:</p>
        <div className="space-y-4">
          <label className="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer has-[:checked]:bg-blue-50 has-[:checked]:border-blue-300">
            ...
            />
            <span className="ml-3 text-gray-700 font-medium">Disimpan oleh Pengendali Teknis (PT)</span>
          </label>
          <label className="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer has-[:checked]:bg-blue-50 has-[:checked]:border-blue-300">
            <input
              type="radio"
              ...
              className="h-5 w-5 text-blue-600 border-gray-300 focus:ring-blue-500"
            />
            <span className="ml-3 text-gray-700 font-medium">Disimpan oleh Ketua Tim (KT)</span>
          </label>
        </div>
